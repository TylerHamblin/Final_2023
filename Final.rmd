...
The barchart above now shows the graphical results for all people identified on drugs and how they contract Covid-19 based on whether or not they have the vaccine. Left shows positive right shows negative. In this instance it was four or five times more likely that a person who had Covid-19 had also received the vaccine rather than the placebo. This could suggest that drug users are already much more pre disposed to contracting Covid-19 because of weakened immune systems or because of a reverse affect the vaccination has with the drugs in a persons system. This would require a separate study. 
...
According to the numerical results the placebo group accounted for 15% of the people who contracted Covid-19 and the vaccinated people accounted for the other 85%. This confirms the notion from the barchart that with drug users, as opposed to males and females, the vaccine actually increases how often they get Covid-19. The vaccine so far is not effective or advisable. 
...
The p-value of $6.668\times10^{-8}$ still suggests a statistical difference within the data so the reverse in effectiveness is not mere chance. The Chi-Squared statistic is 29 still larger than the degrees of freedom. The odds of a placebo treated versus vaccinated drug user contracting the virus is about 1:5. 
...
The confidence interval for drug users is only 7-26% which is much lower than the >50% recommendation so this should not be implemented as a reliable precaution for the spread of Covid-19 amongst drug users. 
